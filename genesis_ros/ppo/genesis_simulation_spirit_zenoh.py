import argparse
from genesis_ros.ppo.spirit_env import SpiritEnv
...
def eval(
    ...
    urdf_path: str = "assets/urdf/spirit40/spirit40_ros2.urdf",
    device: str = "gpu",
...
def cli_entrypoint():
    ...
    parser.add_argument("-e", "--exp_name", type=str, default="spirit-walking")
    parser.add_argument("--ckpt", type=int, default=100)
    parser.add_argument(
        "--urdf_path",
        help="Path to the URDF file",
        type=str,
        default="assets/urdf/spirit40/spirit40_ros2.urdf",
    )
    parser.add_argument(
        "-i",
        "--interface",
